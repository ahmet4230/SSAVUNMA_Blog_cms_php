        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered">
                ...
                if(isset($_POST["add_post"])){
                    ...
                    $query = "INSERT INTO posts (post_title, post_category, post_author, post_text, post_tags, post_date, post_comment_number, post_image)";
                    $query .= "VALUES ('{$post_title}', '{$post_category}', '{$post_author}', '{$post_text}', '{$post_tags}', now(), '{$post_comment_number}', '{$post_image}')";

                     $crate_post_query = mysqli_query($conn,$query);
                ...
                $sql_guery = "SELECT * from posts ORDER BY post_id DESC";
                $select_all_posts = mysqli_query($conn,$sql_guery);
                $k = 1;
                    while($row = mysqli_fetch_assoc($select_all_posts)){
                        ...
                        $post_id= $row["post_id"];
                         ...
                         $post_image= $row["post_image"];
                         $post_text= substr($row["post_text"],0,500);
                         $post_comment_number= 8;
...
<input type="text" class="form-control" name="post_title" value="<?php echo $post_title; ?>">
                    ...
                    <label for="post_category">Post Category</label>
                                            <select class="form_group" name="post_category">
