            ...
            <table class="table table-bordered">
                ...
                if(isset($_POST["add_user"])){
                    ...
                    $query .= "VALUES ('{$user_name}', '{$user_email}', '{$user_password}', '{$user_role}')";
                     ...
                     $crate_user_query = mysqli_query($conn,$query);
...
$sql_guery = "SELECT * from users ORDER BY user_id DESC";
$select_all_users = mysqli_query($conn,$sql_guery);
$k = 1;
...
?>
                    ...
                    <?php $k++; } ?>
                         ...
                         <a class="btn btn-large btn-primary" data-toggle="modal" data-target="#add_modal">Kulanıcı ekle</a>
