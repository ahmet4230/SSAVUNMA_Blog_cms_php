...
$sql_guery = "SELECT * from comments ORDER BY comment_id DESC";
$select_all_comments = mysqli_query($conn,$sql_guery);
$k = 1;
    while($row = mysqli_fetch_assoc($select_all_comments)){
        ...
        $comment_post_id= $row["comment_post_id"];
         ...
         $comment_text= substr($row["comment_text"],0,500);
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" readonly name="comment_text" id="" cols="20" rows="5"><?php echo $comment_text;?>
                                            </textarea>
                                        </div>
                                        <div class="form-group">
